...
public record StudentDocumentResponse(Long id, Long studentId, String documentType, String fileReference,
		String fileName, String mimeType, String verificationStatus, Long verifiedBy, Instant verifiedAt, String status) {

	static StudentDocumentResponse from(StudentDocument document) {
		return new StudentDocumentResponse(document.getId(), document.getStudent().getId(), document.getDocumentType(),
				...
				document.getVerificationStatus().name(), document.getVerifiedBy(), document.getVerifiedAt(),
