...
export function FeeCategoriesPanel() {
	...
	function refresh() {
		listFeeCategories()
			.then(setCategories)
			.catch((err) => setError(err instanceof ApiError ? err.message : "Failed to load fee categories"));
	}
	...
	async function handleSubmit(event: FormEvent) {
		...
		try {
			...
			setError(err instanceof ApiError ? err.message : "Failed to create fee category");
		} finally {
			setSubmitting(false);
		}
	}
