...
**Not yet decided**: RBAC/permission enforcement (still outstanding since Foundation, now spanning seven modules' worth of unchecked permission codes) vs. backfilling Academic Foundation's test gap vs. picking up one of the remaining light-sketch modules (Transportation/Library/Inventory/HR — none deep-designed yet, see erp-system-plan.md §3.3). Surface options before picking.
