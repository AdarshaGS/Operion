...
**Not yet decided**: RBAC/permission enforcement (still outstanding since Foundation) vs. milestone 5 (Fees) vs. backfilling Academic Foundation's test gap. Surface options before picking.
